            ...
            <div class="twitter_top_wrapper">
                <div class="twitter_top_box">
                    ...
                    <ul class="twitter_top_menu">
                        ...
                        <li class="twitter_top_menu-inner"><a href="/edit-page"><img class="twitter_top_menu-image twitter-profile_image" src="<?php echo e(asset('/storage/images/'.$user->product_image)); ?>" alt="">プロフィール</a></li>
                        <li class="twitter_top_menu-inner"><a href="/users"><img class="twitter_top_menu-image" src="<?php echo e(asset('image/users.png')); ?>" alt="">他のユーザー</a></li>
                    </ul>
